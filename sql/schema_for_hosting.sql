-- Импорт на хостинге (Beget и т.п.), когда база УЖЕ создана в панели (например goingh0o_main).
--
-- В phpMyAdmin: слева ВЫБЕРИТЕ свою базу → вкладка «Импорт» → этот файл.
-- Не используйте sql/schema.sql целиком: там USE culinary_blog — таблицы попадут не в вашу базу.
--
...
-- Админ: admin@example.com / пароль password — смените после входа
